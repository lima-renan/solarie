  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Filtrar Produtos</h1>
        <AiOutlineClose
      ...
      <section className="py-3">
        <FilterHeading text="Faixa de Preço" />
        <InputRange />
      </section>
      <section className="py-3">
        <FilterHeading text="Categorias" />
